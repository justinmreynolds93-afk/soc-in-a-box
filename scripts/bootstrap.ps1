...
if (-not (Test-Path .env)) {
    ...
    # UTF-8 without BOM - Windows PowerShell's -Encoding utf8 adds a BOM that
    # docker compose chokes on.
    [System.IO.File]::WriteAllText("$repo\.env", $env, (New-Object System.Text.UTF8Encoding $false))
